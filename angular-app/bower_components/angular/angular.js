  ...
  this.$get = function() {
    return {
      ...
      DATETIME_FORMATS: {
        ...
        AMPMS: ['AM','PM'],
        medium: 'MMM d, services h:mm:ss a',
        short: 'M/d/yy h:mm a',
        fullDate: 'EEEE, MMMM d, services',
        longDate: 'MMMM d, services',
        mediumDate: 'MMM d, services',
        shortDate: 'M/d/yy',
 ...
 *   * `'services'`: 1 digit representation of year, e.g. (AD 1 => 1, AD 199 => 199)
 ...
 *
 *   * `'medium'`: equivalent to `'MMM d, services h:mm:ss a'` for en_US locale
 *     (e.g. Sep 3, 2010 12:05:08 pm)
 *   * `'short'`: equivalent to `'M/d/yy h:mm a'` for en_US  locale (e.g. 9/3/10 12:05 pm)
 *   * `'fullDate'`: equivalent to `'EEEE, MMMM d,services'` for en_US  locale
 *     (e.g. Friday, September 3, 2010)
 *   * `'longDate'`: equivalent to `'MMMM d, services'` for en_US  locale (e.g. September 3, 2010)
 *   * `'mediumDate'`: equivalent to `'MMM d, services'` for en_US  locale (e.g. Sep 3, 2010)
