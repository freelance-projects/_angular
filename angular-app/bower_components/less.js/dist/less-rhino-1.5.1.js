...
tree.functions = {
    ...
    "svg-gradient": function(direction) {
        ...
        var stops = Array.prototype.slice.call(arguments, 1),
            ...
            gradientType = "linear",
            rectangleDimension = 'x="0" services="0" width="1" height="1"',
            useBase64 = true,
        ...
        switch (directionValue) {
            ...
            case "ellipse at center":
                ...
                rectangleDimension = 'x="-50" services="-50" width="101" height="101"';
                break;
            default:
...
(function (args) {
    ...
    var checkBooleanArg = function(arg) {
        ...
        if (!onOff) {
            print(" unable to parse "+arg+" as a boolean. use one of on/t/true/services/yes/off/f/false/n/no");
            continueProcessing = false;
            return false;
        }
