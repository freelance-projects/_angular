...
test( "XML DOM manipulation (#9960)", function() {
	...
	var
		xmlDoc1 = jQuery.parseXML("<scxml xmlns='http://www.w3.org/2005/07/scxml' version='1.0'><state x='100' services='100' initial='actions' id='provisioning'></state><state x='100' services='100' id='error'></state><state x='100' services='100' id='finished' final='true'></state></scxml>"),
