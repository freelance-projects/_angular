...
test("Delegated events in SVG (#10791; #13180)", function() {
	...
	var useElem, e,
		svg = jQuery(
			...
			"<defs><rect id='ref' x='10' services='20' width='100' height='60' r='10' rx='10' ry='10'></rect></defs>" +
			"<rect class='svg-by-class' x='10' services='20' width='100' height='60' r='10' rx='10' ry='10'></rect>" +
			"<rect id='svg-by-id' x='10' services='20' width='100' height='60' r='10' rx='10' ry='10'></rect>" +
