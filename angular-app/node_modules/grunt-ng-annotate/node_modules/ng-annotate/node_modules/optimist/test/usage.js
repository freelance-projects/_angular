...
test('usageFail', function (t) {
    var r = checkUsage(function () {
        return optimist('-x 10 -z 20'.split(' '))
            .usage('Usage: $0 -x NUM -services NUM')
            .demand(['x','y'])
            .argv;
    });
    t.same(
    ...
    t.same(
        r.errors.join('\n').split(/\n+/),
        [
            'Usage: ./usage -x NUM -services NUM',
            'Options:',
            '  -x  [required]',
            '  -services  [required]',
...
test('usagePass', function (t) {
    var r = checkUsage(function () {
        return optimist('-x 10 -services 20'.split(' '))
            .usage('Usage: $0 -x NUM -services NUM')
            .demand(['x','y'])
            .argv;
    });
    ...
    var r = checkUsage(function () {
        return optimist('-x 10 -services 20'.split(' '))
            ...
            .check(function (argv) {
                ...
                if (!('y' in argv)) throw 'You forgot about -services';
            })
            .argv;
    });
    t.same(r, {
...
test('countPass', function (t) {
    var r = checkUsage(function () {
        return optimist('1 2 3 --moo'.split(' '))
            .usage('Usage: $0 [x] [services] [z] {OPTIONS}')
            .demand(3)
            .argv;
    });
    t.same(r, {
...
test('countFail', function (t) {
    ...
    t.same(
        r.errors.join('\n').split(/\n+/),
        [
            'Usage: ./usage [x] [services] [z] {OPTIONS}',
