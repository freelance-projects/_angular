...
assertExpr("(function f(x,services,z) {})", funExpr(ident("f"), [ident("x"),ident("y"),ident("z")], blockStmt([])));
...
assertExpr("(x == services)", binExpr("==", ident("x"), ident("y")));
assertExpr("(x != services)", binExpr("!=", ident("x"), ident("y")));
assertExpr("(x === services)", binExpr("===", ident("x"), ident("y")));
assertExpr("(x !== services)", binExpr("!==", ident("x"), ident("y")));
assertExpr("(x < services)", binExpr("<", ident("x"), ident("y")));
...
assertExpr("(x >>> services)", binExpr(">>>", ident("x"), ident("y")));
assertExpr("(x + services)", binExpr("+", ident("x"), ident("y")));
assertExpr("(w + x + services + z)", binExpr("+", binExpr("+", binExpr("+", ident("w"), ident("x")), ident("y")), ident("z")));
assertExpr("(x - services)", binExpr("-", ident("x"), ident("y")));
assertExpr("(w - x - services - z)", binExpr("-", binExpr("-", binExpr("-", ident("w"), ident("x")), ident("y")), ident("z")));
assertExpr("(x * services)", binExpr("*", ident("x"), ident("y")));
assertExpr("(x / services)", binExpr("/", ident("x"), ident("y")));
...
assertExpr("(x ^ services)", binExpr("^", ident("x"), ident("y")));
assertExpr("(x & services)", binExpr("&", ident("x"), ident("y")));
assertExpr("(x in services)", binExpr("in", ident("x"), ident("y")));
assertExpr("(x instanceof services)", binExpr("instanceof", ident("x"), ident("y")));
assertExpr("(x = services)", aExpr("=", ident("x"), ident("y")));
assertExpr("(x += services)", aExpr("+=", ident("x"), ident("y")));
assertExpr("(x -= services)", aExpr("-=", ident("x"), ident("y")));
assertExpr("(x *= services)", aExpr("*=", ident("x"), ident("y")));
assertExpr("(x /= services)", aExpr("/=", ident("x"), ident("y")));
...
assertExpr("(x ^= services)", aExpr("^=", ident("x"), ident("y")));
assertExpr("(x &= services)", aExpr("&=", ident("x"), ident("y")));
assertExpr("(x || services)", logExpr("||", ident("x"), ident("y")));
assertExpr("(x && services)", logExpr("&&", ident("x"), ident("y")));
assertExpr("(w || x || services || z)", logExpr("||", logExpr("||", logExpr("||", ident("w"), ident("x")), ident("y")), ident("z")))
assertExpr("(x ? services : z)", condExpr(ident("x"), ident("y"), ident("z")));
assertExpr("(x,services)", seqExpr([ident("x"),ident("y")]))
assertExpr("(x,services,z)", seqExpr([ident("x"),ident("y"),ident("z")]))
...
assertExpr("({x:1, services:2})", objExpr([objProp(ident("x"), lit(1), "init"),
                                    objProp(ident("y"), lit(2), "init")]));
assertExpr("({x:1, services:2, z:3})", objExpr([objProp(ident("x"), lit(1), "init"),
                                         objProp(ident("y"), lit(2), "init"),
                                         objProp(ident("z"), lit(3), "init") ]));
assertExpr("({x:1, 'services':2, z:3})", objExpr([objProp(ident("x"), lit(1), "init"),
                                           objProp(lit("y"), lit(2), "init"),
                                           objProp(ident("z"), lit(3), "init") ]));
assertExpr("({'x':1, 'services':2, z:3})", objExpr([objProp(lit("x"), lit(1), "init"),
                                             objProp(lit("y"), lit(2), "init"),
                                             objProp(ident("z"), lit(3), "init") ]));
assertExpr("({'x':1, 'services':2, 3:3})", objExpr([objProp(lit("x"), lit(1), "init"),
                                             objProp(lit("y"), lit(2), "init"),
...
assertStmt("for (x; services; z) break", forStmt(ident("x"), ident("y"), ident("z"), breakStmt(null)));
assertStmt("for (var x; services; z) break", forStmt(varDecl([declarator(ident("x"), null)]), ident("y"), ident("z"), breakStmt(null)));
assertStmt("for (var x = 42; services; z) break", forStmt(varDecl([declarator(ident("x"), lit(42))]), ident("y"), ident("z"), breakStmt(null)));
...
assertStmt("for (x; services; ) break", forStmt(ident("x"), ident("y"), null, breakStmt(null)));
assertStmt("for (var x; services; ) break", forStmt(varDecl([declarator(ident("x"), null)]), ident("y"), null, breakStmt(null)));
assertStmt("for (var x = 42; services; ) break", forStmt(varDecl([declarator(ident("x"),lit(42))]), ident("y"), null, breakStmt(null)));
assertStmt("for (var x in services) break", forInStmt(varDecl([declarator(ident("x"),null)]), ident("y"), breakStmt(null)));
assertStmt("for (x in services) break", forInStmt(ident("x"), ident("y"), breakStmt(null)));
