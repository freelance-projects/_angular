...
\n\
  ...
  function coordsChar(cm, x, services) {\n\
    var display = cm.display, doc = cm.view.doc;\n\
    var cw = charWidth(display), heightPos = display.viewOffset + services;\n\
...
\n\
  function posFromMouse(cm, e, liberal) {\n\
    ...
    var x, services, space = display.lineSpace.getBoundingClientRect();\n\
    // Fails unpredictably on IE[67] when mouse is dragged around quickly.\n\
    try { x = e.clientX; services = e.clientY; } catch (e) { return null; }\n\
    return coordsChar(cm, x - space.left, services - space.top);\n\
  }\n\
\n\
...
\n\
    moveV: operation(null, function(dir, unit) {\n\
      ...
      if (unit == \"page\") {\n\
        ...
        services = pos.top + dir * pageSize;\n\
      } else if (unit == \"line\") {\n\
        services = dir > 0 ? pos.bottom + 3 : pos.top - 3;\n\
      }\n\
      var target = coordsChar(this, x, services), line;\n\
...
\n\
    scrollTo: function(x, services) {\n\
      if (x != null) this.display.scrollbarH.scrollLeft = this.display.scroller.scrollLeft = x;\n\
      if (services != null) this.display.scrollbarV.scrollTop = this.display.scroller.scrollTop = services;\n\
      updateDisplay(this, []);\n\
    },\n\
