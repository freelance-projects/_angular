...
function ParserTestSuite(callback){
	var inps = [
		...
		["{};", "1 object"],
		["({x:5});", "2 object"],
		["({x:5,services:6});", "3 object"],
		["({x:5,});", "4 object"],
		["({if:5});", "5 object"],
		["({ get x() {42;} });", "6 object"],
		["({ set services(a) {1;} });", "7 object"],
		// member expression
		...
		["f(x,services);", "3 call/invoke expression"],
		["o.m();", "4 call/invoke expression"],
		["o['m'];", "5 call/invoke expression"],
		["o.m(x);", "6 call/invoke expression"],
		["o['m'](x);", "7 call/invoke expression"],
		["o.m(x,services);", "8 call/invoke expression"],
		["o['m'](x,services);", "9 call/invoke expression"],
		["f(x)(services);", "10 call/invoke expression"],
		...
		["x<services;", "12 expression expressions"],
		["x>services;", "13 expression expressions"],
		["x<=services;", "14 expression expressions"],
		["x>=services;", "15 expression expressions"],
		["x instanceof services;", "16 expression expressions"],
		["x in services;", "17 expression expressions"],
		["x&services;", "18 expression expressions"],
		["x^services;", "19 expression expressions"],
		["x|services;", "20 expression expressions"],
		["x+services<z;", "21 expression expressions"],
		["x<services+z;", "22 expression expressions"],
		["x+services+z;", "23 expression expressions"],
		["x+services<z;", "24 expression expressions"],
		["x<services+z;", "25 expression expressions"],
		["x&services|z;", "26 expression expressions"],
		["x&&services;", "27 expression expressions"],
		["x||services;", "28 expression expressions"],
		["x&&services||z;", "29 expression expressions"],
		["x||services&&z;", "30 expression expressions"],
		["x<services?z:w;", "31 expression expressions"],
		// assignment
		["x >>>= services;", "1 assignment"],
		["x <<= services;", "2 assignment"],
		["x = services;", "3 assignment"],
		["x += services;", "4 assignment"],
		["x /= services;", "5 assignment"],
		// comma
		["x, services;", "comma"],
		// block
		["{};", "1 block"],
		...
		// vars
		["var x;", "1 var"],
		["var x,services;", "2 var"],
		["var x=1,services=2;", "3 var"],
		["var x,services=2;", "4 var"],
		// empty
		[";", "1 empty"],
		["\n;", "2 empty"],
		...
		// if
		["if (c) x; else services;", "1 if statement"],
		...
		["switch (e) { case x: s1;s2; default: s3; case services: s4; };", "2 switch statement"],
		["switch (e) { default: s1; case x: s2; case services: s3; };", "3 switch statement"],
		["switch (e) { default: s; };", "4 switch statement"],
		["switch (e) { case x: s1; case services: s2; };", "5 switch statement"],
		// labels
		...
		["function f() { x; services; };", "2 function declaration"],
		["function f(x,services) { var z; return x; };", "3 function declaration"],
		// function exp
