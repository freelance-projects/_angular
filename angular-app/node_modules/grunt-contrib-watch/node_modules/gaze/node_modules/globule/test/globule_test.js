...
exports['mapping'] = {
  ...
  'options.ext': function(test) {
    ...
    actual = globule.mapping(['x/a.js', 'x.services/b.min.js', 'x.services/z.z/c'], {ext: '.foo'});
    expected = [
      {dest: 'x/a.foo', src: ['x/a.js']},
      {dest: 'x.services/b.foo', src: ['x.services/b.min.js']},
      {dest: 'x.services/z.z/c.foo', src: ['x.services/z.z/c']},
    ];
  ...
  'options.extDot': function(test) {
    ...
    actual = globule.mapping(['x/a.js', 'x.services/b.bbb.min.js', 'x.services/z.z/c'], {ext: '.foo', extDot: 'first'});
    expected = [
      {dest: 'x/a.foo', src: ['x/a.js']},
      {dest: 'x.services/b.foo', src: ['x.services/b.bbb.min.js']},
      {dest: 'x.services/z.z/c.foo', src: ['x.services/z.z/c']},
    ];
    test.deepEqual(actual, expected, 'extDot of "first" should replace everything after the first dot in the filename.');

    actual = globule.mapping(['x/a.js', 'x.services/b.bbb.min.js', 'x.services/z.z/c'], {ext: '.foo', extDot: 'last'});
    expected = [
      {dest: 'x/a.foo', src: ['x/a.js']},
      {dest: 'x.services/b.bbb.min.foo', src: ['x.services/b.bbb.min.js']},
      {dest: 'x.services/z.z/c.foo', src: ['x.services/z.z/c']},
    ];
