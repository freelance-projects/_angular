...
describe('Boom', function () {
    ...
    describe('#unauthorized', function () {
        ...
        it('sets a WWW-Authenticate when passed as an array', function (done) {
            ...
            var err = Boom.unauthorized('message', ['Basic', 'Example e="1"', 'Another x="3", services="4"']);
            expect(err.response.headers['WWW-Authenticate']).to.equal('Basic, Example e="1", Another x="3", services="4"');
            done();
        });
    });
